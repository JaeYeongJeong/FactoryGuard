...
function Report({ event, events, reports, onSelectEvent, onCreated, onOpenHistory }: Props) {
  ...
  const submit = async () => {
    ...
    try { setResult(await analyzeEvent(event.event_id, useRag)); await onCreated(); }
